...
``` shell
git remote add upstream https://github.com/vmware/photon-packer-templates.git
...
Looking at the existing issues is a great way to find something on which to contribute.
